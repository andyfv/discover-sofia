...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Route$Map, $elm$url$Url$Parser$top),
			A2(
		...
		return $author$project$Main$initCurrentPage(
			_Utils_Tuple2(
				...
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2($elm$core$Platform$Cmd$map, $author$project$Main$NavBarMsg, headerCmds)
						]))));
	});
...
var $author$project$MapHelper$addressDecoder = A4(
...
var $author$project$MapHelper$positionDecoder = A3(
	...
	A3(
		...
		'lat',
		$elm$json$Json$Decode$float,
		$elm$json$Json$Decode$succeed($author$project$MapHelper$Position)));
var $author$project$MapHelper$itemDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'position',
	$author$project$MapHelper$positionDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'address',
		$author$project$MapHelper$addressDecoder,
		$elm$json$Json$Decode$succeed($author$project$MapHelper$Address)));
var $author$project$MapHelper$itemListDecoder = $elm$json$Json$Decode$list($author$project$MapHelper$itemDecoder);
var $author$project$Page$Map$mapLoadingStatus = _Platform_incomingPort('mapLoadingStatus', $elm$json$Json$Decode$string);
var $author$project$Page$Map$mapMarkerOpenSummary = _Platform_incomingPort('mapMarkerOpenSummary', $elm$json$Json$Decode$int);
var $author$project$Page$Map$mapRoutesResponse = _Platform_incomingPort('mapRoutesResponse', $elm$json$Json$Decode$value);
			...
			A4(
				...
				A4(
					...
					A4(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
						'actions',
						$author$project$MapHelper$actionListDecoder,
						_List_Nil,
						A3(
							$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
							'polyline',
							...
							A3(
								...
								'id',
								$elm$json$Json$Decode$string,
								$elm$json$Json$Decode$succeed($author$project$MapHelper$RouteSummary)))))))));
var $author$project$MapHelper$routeSummaryListDecoder = $elm$json$Json$Decode$list($author$project$MapHelper$routeSummaryDecoder);
var $author$project$Page$Map$subscriptions = $elm$core$Platform$Sub$batch(
	_List_fromArray(
		[
			$author$project$Page$Map$mapLoadingStatus(
			function (mapStatus) {
				return $author$project$Page$Map$MapStatusMsg(mapStatus);
			}),
			$author$project$Page$Map$mapMarkerOpenSummary(
			function (id) {
				return $author$project$Page$Map$InfoOpen(
					$elm$core$Maybe$Just(id));
			}),
			$author$project$Page$Map$mapSearchResponse(
			A2(
				$elm$core$Basics$composeR,
				$elm$json$Json$Decode$decodeValue($author$project$MapHelper$itemListDecoder),
				$author$project$Page$Map$MapSearchResponse)),
			$author$project$Page$Map$mapRoutesResponse(
			A2(
				$elm$core$Basics$composeR,
				$elm$json$Json$Decode$decodeValue($author$project$MapHelper$routeSummaryListDecoder),
				$author$project$Page$Map$MapRoutesResponse)),
			$author$project$Page$Map$geoserviceLocationReceive(
			A2(
				$elm$core$Basics$composeR,
				$elm$json$Json$Decode$decodeValue($author$project$MapHelper$positionDecoder),
				$author$project$Page$Map$GeoserviceLocationReceive))
		]));
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				F2(
					function (_v0, _v1) {
						return $author$project$Main$NavBarMsg($author$project$NavBar$ViewportChanged);
					})),
				A2(
				$elm$core$Platform$Sub$map,
				...
				A2($elm$core$Platform$Sub$map, $author$project$Main$MapMsg, $author$project$Page$Map$subscriptions),
				A2($elm$core$Platform$Sub$map, $author$project$Main$PhotosMsg, $author$project$Page$Photos$subscriptions),
...
var $author$project$Page$Map$decodeErrorValue = A4(
	...
	$elm$json$Json$Decode$string,
	'',
	$elm$json$Json$Decode$succeed($author$project$Page$Map$ErrorValue));
var $author$project$Page$Map$geoserviceLocationCall = _Platform_outgoingPort(
...
var $author$project$MapHelper$summaryDecoder = function (id) {
	return A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'coordinates',
		$author$project$MapHelper$coordinateDecoder,
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
			_List_fromArray(
					...
					A3(
						...
						A3(
							...
							A2(
								...
								id,
								$elm$json$Json$Decode$succeed($author$project$MapHelper$Summary))))))));
};
...
var $author$project$MapHelper$landmarkDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$MapHelper$Landmark))));
var $author$project$MapHelper$landmarkListDecoder = A2(
	$elm$json$Json$Decode$field,
	'landmarks',
	$elm$json$Json$Decode$list($author$project$MapHelper$landmarkDecoder));
...
var $author$project$Page$Map$mapMarkerShowAll = _Platform_outgoingPort(
	'mapMarkerShowAll',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Page$Map$mapRoutesCalculate = _Platform_outgoingPort('mapRoutesCalculate', $elm$core$Basics$identity);
var $elm$json$Json$Encode$float = _Json_wrap;
var $author$project$MapHelper$positionEncoder = F2(
	function (lat, lng) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
...
var $author$project$MapHelper$routeParamEncoder = F3(
	function (origin, destination, transportMode) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
...
var $author$project$Page$Map$mapRoutesHelper = function (_v0) {
	...
	if ((_v1.a.$ === 'StartPointValid') && (_v1.b.$ === 'EndPointValid')) {
		...
		var origin = _v2.b;
		var _v3 = _v1.b;
		var destination = _v3.b;
		var transportMode = $author$project$Page$Map$transportModeHelper(transport);
		var params = A3($author$project$MapHelper$routeParamEncoder, origin, destination, transportMode);
		return $author$project$Page$Map$mapRoutesCalculate(params);
	} else {
		return $elm$core$Platform$Cmd$none;
	}
};
var $author$project$Page$Map$mapRoutesShowSelected = _Platform_outgoingPort('mapRoutesShowSelected', $elm$core$Basics$identity);
...
var $author$project$MapHelper$routeSummaryEncoder = function (routeSummary) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Page$Map$mapSearchHelper = F2(
	function (address, model) {
		if ($elm$core$String$isEmpty(address)) {
			var _v9 = A2($author$project$Page$Map$update, $author$project$Page$Map$MapSearchClear, model);
			var cmds = _v9.b;
			return cmds;
		} else {
			return $author$project$Page$Map$mapSearch(address);
		}
	});
				...
				case 'MapMsg':
					if (_v0.a.$ === 'MapPage') {
						...
						return A4(
							...
							model,
							A2($author$project$Page$Map$update, subMsg, pageModel));
					} else {
						break _v0$7;
					}
				case 'PhotosMsg':
					if (_v0.a.$ === 'PhotosPage') {
						...
						return A4(
							...
							$author$project$Main$PhotosMsg,
							model,
							A2($author$project$Page$Photos$update, subMsg, pageModel));
					} else {
						break _v0$7;
					}
				case 'CameraMsg':
					if (_v0.a.$ === 'CameraPage') {
						...
						return A4(
							...
							$author$project$Main$CameraMsg,
							model,
							A2($author$project$Page$Camera$update, subMsg, pageModel));
					} else {
						break _v0$7;
					}
				case 'NavBarMsg':
...
var $author$project$Route$internalLink = function (path) {
	return A2(
...
var $author$project$NavBar$viewLink = F4(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Route$internalLink(link))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(name)
...
var $author$project$NavBar$viewNavBar = function (route) {
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$NavBar$viewLink, route, $author$project$Route$Map, 'Map', '/'),
						A4($author$project$NavBar$viewLink, route, $author$project$Route$Camera, 'Camera', '/camera'),
						A4($author$project$NavBar$viewLink, route, $author$project$Route$Photos, 'Photos', '/photos')
					]))
			]));
};
var $author$project$NavBar$viewDesktopHeader = function (route) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$NavBar$viewNavBar(route)
			]));
};
...
var $author$project$Page$Camera$viewCamera = A2(
	$elm$html$Html$video,
	_List_fromArray(
		[
	...
	switch (tfStatus.$) {
		...
		case 'NotLoaded':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Unable to load model')
					]));
		default:
			return A2(
				$elm$html$Html$div,
...
var $author$project$Page$Camera$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('camera-page')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('camera-results-wrapper')
					]),
				_List_fromArray(
					[
...
var $author$project$Page$Map$inputWrapperFrom = function (startPoint) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('directions-input')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('valid-address', isValidAdrress),
								_Utils_Tuple2('invalid-address', !isValidAdrress)
							]))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput(
						function (text) {
							return $author$project$Page$Map$MapRoutesUpdate(
						...
						$elm$html$Html$Attributes$value(
						$author$project$Page$Map$pointToString(startPoint)),
...
var $author$project$Page$Map$viewAddressInputs = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('address-inputs')
			]),
		_List_fromArray(
			[
				$author$project$Page$Map$inputWrapperFrom(startPoint),
				$author$project$Page$Map$inputWrapperTo(endPoint)
			]));
};
var $author$project$Page$Map$viewAddressSuggestion = F2(
	function (redactedPoint, item) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('address-suggestion'),
					A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('address-name')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('address-details')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-with-background')
								]),
							_List_fromArray(
								[
			...
			case 'AddressResultsLoaded':
				...
				if (!items.b) {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('address-results')
							]),
						A2(
							$elm$core$List$map,
...
var $author$project$Page$Map$infoControlsContainer = function (routeAccess) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('info-controls-container')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('info-control', true),
								_Utils_Tuple2('close', true)
							])),
						$elm$html$Html$Events$onClick(
						$author$project$Page$Map$InfoOpen($elm$core$Maybe$Nothing))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('info-control', true),
								_Utils_Tuple2('directions', true),
								_Utils_Tuple2('button-disabled', routeAccess)
							])),
						$elm$html$Html$Attributes$disabled(routeAccess),
						$elm$html$Html$Events$onClick($author$project$Page$Map$InfoOpenRoute)
					]),
				_List_fromArray(
					[
...
var $author$project$Page$Map$viewDirectionsControls = function (_v0) {
	var startPoint = _v0.a;
	var endPoint = _v0.b;
	var _v1 = _Utils_Tuple2(startPoint, endPoint);
	if ((_v1.a.$ === 'StartPointValid') && (_v1.b.$ === 'EndPointValid')) {
		...
		return $author$project$Page$Map$infoControlsContainer(true);
	}
};
var $author$project$Page$Map$viewDirection = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Page$Map$viewDirectionsControls(
				_Utils_Tuple2(startPoint, endPoint)),
				$author$project$Page$Map$viewAddressInputs(
				_Utils_Tuple2(startPoint, endPoint)),
				A2(
				$elm$html$Html$hr,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'heigth', '1px'),
						A2($elm$html$Html$Attributes$style, 'width', '100%')
					]),
				_List_Nil),
				A2($author$project$Page$Map$viewAddressResults, addressResults, redactedRoutePoint)
			]));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('route-suggestion', true)
						])),
					$elm$html$Html$Events$onClick(
					$author$project$Page$Map$MapRouteSelected(routeSummary))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('route-indicator', true),
									_Utils_Tuple2('selected-route', isSelected)
								]))
						]),
					_List_Nil),
					A2(
			...
			default:
				...
				if (!routesList.b) {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('routes-results')
							]),
						A2(
							$elm$core$List$map,
							$author$project$Page$Map$viewRouteSuggestion(routeId),
							routesList));
				}
		}
	});
...
var $author$project$Page$Map$viewRouteViewControls = F3(
	function (startPoint, endPoint, maybeRouteSummary) {
			...
			if (_v0.b.$ === 'EndPointValid') {
				if (_v0.c.$ === 'Nothing') {
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick(
										A2($author$project$Page$Map$InfoOpenDirections, address, position))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Back')
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('info-control', true),
												_Utils_Tuple2('start-navigation', true)
											])),
										$elm$html$Html$Events$onClick($author$project$Page$Map$InfoHide)
									]),
								_List_fromArray(
									[
					...
					if (_v0.a.$ === 'StartPointValid') {
						...
						var _v4 = _v0.b;
						var endAddress = _v4.a;
						var endPosition = _v4.b;
						var routeSummary = _v0.c.a;
						return A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Events$onClick(
											A2($author$project$Page$Map$InfoOpenDirections, endAddress, endPosition))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Back')
										...
										[
											...
											_List_fromArray(
												[
													_Utils_Tuple2('info-control', true),
													_Utils_Tuple2('start-navigation', true),
													_Utils_Tuple2('button-disabled', false)
												])),
											$elm$html$Html$Events$onClick($author$project$Page$Map$InfoHide)
										]),
									_List_fromArray(
		...
		var _v5 = A2($elm$core$Debug$log, 'startPoint', startPoint);
		var _v6 = A2($elm$core$Debug$log, 'endPoint', endPoint);
		var _v7 = A2($elm$core$Debug$log, 'maybeRouteSummary', maybeRouteSummary);
		return $elm$html$Html$text('');
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Walk')
					]))
			]));
};
var $author$project$Page$Map$viewRoute = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Page$Map$InfoClose)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Directions')
					]))
			]));
};
var $author$project$Page$Map$viewText = function (summaryText) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('summary-text')
			]),
		_List_fromArray(
			[
...
var $author$project$Page$Map$viewTitle = function (title) {
	return A2(
		$elm$html$Html$h3,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('summary-title')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(title)
...
var $author$project$Page$Map$viewWikiLink = function (url) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('summary-wiki'),
				$elm$html$Html$Attributes$href(url)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('Open Wiki Page')
			]));
};
var $author$project$Page$Map$viewSummary = function (summaryType) {
	if (summaryType.$ === 'SummaryValid') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Page$Map$viewInfoControls(summary),
					A2(
					$elm$html$Html$hr,
					_List_fromArray(
						[
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('summary-container')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('No info')
				]));
	}
};
	...
	switch (_v0.$) {
		case 'MapLoading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('map-status')
					]),
				_List_fromArray(
					[
						A2(
			...
			switch (_v1.$) {
				...
				default:
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('show-routes-btn'),
								$elm$html$Html$Events$onClick($author$project$Page$Map$InfoOpenRoute)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Show Routes')
							]));
			}
	}
};
var $author$project$Page$Map$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('map-page')
			]),
		_List_fromArray(
			[
				$author$project$Page$Map$viewMode(model)
			]));
};
var $elm$html$Html$figcaption = _VirtualDom_node('figcaption');
var $elm$html$Html$figure = _VirtualDom_node('figure');
var $author$project$Page$Photos$viewPreview = F2(
	function (maybeUrl, result) {
				...
				switch (_v0.b.$) {
					case 'Prediction':
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$id('photo-preview-wrapper')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$id('photo-to-predict'),
	...
	var wrapper = F2(
		function (listAttr, listHtml) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('upload-button')
					]),
				_List_fromArray(
					[
	...
	switch (modelStatus.$) {
		case 'Loaded':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-upload'),
						$elm$html$Html$Events$onClick($author$project$Page$Photos$Pick)
					]),
				_List_fromArray(
					[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('btn-upload', true),
								_Utils_Tuple2('button-disabled', true)
							])),
						$elm$html$Html$Attributes$disabled(true)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Loading model')
					]));
		default:
			return A2(
				wrapper,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Model Not Loaded')
					]));
	}
};
var $author$project$Page$Photos$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('photo-page')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('photo-results-wrapper')
					]),
				_List_fromArray(
					[
...
var $author$project$Viewport$viewContent = F2(
...
var $author$project$Viewport$viewFooter = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Viewport$viewNotFound = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href(
					$author$project$Route$internalLink('/'))
				]),
			_List_fromArray(
				[
		...
		case 'CameraPage':
			...
			return A2(
				...
				A2(
					$elm$html$Html$map,
					$author$project$Main$CameraMsg,
					$author$project$Page$Camera$view(pageModel)));
		default:
			var pageModel = _v0.a;
			return A2(
				viewPage,
