...
var $author$project$TF$NotLoaded = 0;
...
var $author$project$TF$Empty = {$: 2};
var $author$project$TF$Loading = 2;
...
var $author$project$Page$Camera$init = function (tfStatus) {
		...
		switch (tfStatus) {
			case 0:
				return _Utils_Tuple2(
					$author$project$TF$tfLoad(0),
					2);
			case 1:
				return _Utils_Tuple2(
					$author$project$TF$tfVideoPredict(0),
					tfStatus);
			default:
	...
	return _Utils_Tuple2(
		{X: $author$project$TF$Empty, N: newTFStatus},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[cmds])));
};
...
var $author$project$Page$Photos$init = function (tfStatus) {
	...
	var newTFStatus = _v0.b;
	return _Utils_Tuple2(
		{ap: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, X: $author$project$TF$Empty, N: newTFStatus},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[cmds])));
};
...
var $author$project$TF$Loaded = 1;
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								X: $author$project$TF$PredictionErr('Error parsing the prediction')
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Page$Map$LoadLandmarskWiki = function (a) {
	return {$: 16, a: a};
};
	...
	return $elm$http$Http$get(
		{
			aL: A2(
				...
				$author$project$Page$Map$LoadLandmarskWiki,
